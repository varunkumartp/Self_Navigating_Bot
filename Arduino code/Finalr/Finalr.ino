...
// Timer1 Content
long TimerContent1 = ((long)(16e6) * DELAY1 / 1024) - 1;
...
void setup()
{
  ...
  OCR1A = TimerContent1;  // = (16*10^6) / (1*1024) - 1 (must be <65536)
